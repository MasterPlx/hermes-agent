...
const ptBR: BotsMessages = {
  roster: {
    search: 'Procurar bots e conversas de grupo',
    searchPlaceholder: 'Procurar bots e conversas de grupo...',
    newBotOrGroup: 'Novo chat de bots ou grupos',
    groupChats: 'Conversas de grupo',
    emptyTitle: 'Sem bots ainda',
    emptyDesc: 'Crie seu primeiro bot.',
    noMatchQuery: query => `Nenhum bots ou chats de grupo correspondem “${query}”`,
    noMatchQueryOn: (query, gateway) => `Nenhum bots ou chats de grupo correspondem “${query}” em ${gateway}`,
    noMatchFiltersOn: gateway => `Nenhum bots ou chats de grupo correspondem a estes filtros ${gateway}`,
    noMatchFilters: 'Nenhum bots ou chats de grupo correspondem a estes filtros.',
    clearFilters: 'Limpar os filtros',
    allHidden: 'Todos os bots estão escondidos',
    allHiddenDesc: 'Eles continuam trabalhando e mantendo o histórico.',
    showHidden: 'Mostrar os bots escondidos',
    noHiddenMatch: 'Nenhum bot oculto corresponde a estes filtros.',
    hiddenFromRoster: 'Escondido da lista',
    pinned: 'Pinado',
    needsAttention: 'precisa de atenção',
    needsInput: 'Precisa da sua entrada',
    botsAndGroups: 'Bots e chats de grupo',
    botsOnly: 'Apenas Bots',
    groupsOnly: 'Apenas chats em grupo',
    ...
    retryNow: 'Tente de novo.',
    rosterUnavailable: reason =>
      `Lista indisponível: ${reason}. Se o gateway for anterior a profiles.list, atualize o Hermes e reinicie o gateway.`,
    waitingForGateway:
      'Aguardando a conexão com o gateway... (gateways remotos podem levar alguns segundos; a tentativa é repetida automaticamente)'
  },
  sections: {
    newSection: 'Nova seção',
    newTitle: 'Nova seção',
    renameTitle: 'Mudar o Nome da seção',
    nameLabel: 'Nome da seção',
    namePlaceholder: 'Por exemplo, Clientes',
    create: 'Criar',
    rename: 'Renomear...',
    moveUp: 'Subir',
    moveDown: 'Mover para baixo',
    unassigned: 'Não atribuído',
    options: name => `${name} opções de seção`,
    headingTip: 'Solte os bots aqui · clique duas vezes para renomear',
    emptyHint: 'Arraste os bots aqui',
    moveTo: 'Mover para a seção',
    newSectionEllipsis: 'Nova seção...',
    removeFromSection: 'Remover da seção',
    deleted: (name, count) =>
      count === 0
        ? `Suprimido “${name}”`
        : `Suprimido “${name}” — ${count} ${count === 1 ? 'bot' : 'bots'} mudou para Sem Atribuir`,
    undo: 'Desfazer'
  },
  bot: {
    newTitle: 'Novo bot',
    ...
    editMenu: 'Editar...',
    helpPromptPlaceholder: 'Em que deve este bot ajudar?',
    descriptionHint: 'Deixe em branco para gerar a partir do nome e descrição do bot.',
    newChatWith: 'Nova conversa com este bot',
    openBotChat: 'Abrir a Conversa de Bots',
    duplicate: 'Duplicar',
    duplicateFailed: 'Duplicar falhou',
    deleteTitle: 'Apagar o bot e o perfil?',
    removeFromAllGroups: 'Remover de todos os grupos',
    createFirstHint: 'Abra o painel Bots e pressione “Novo Bot”.',
    createFailed: 'Não foi possível criar o perfil ainda',
    advanced: 'Avançado',
    advancedHint: 'Avançado — modelo, habilidades, conjuntos de ferramentas, SOUL.md',
    advancedFailed: 'A configuração avançada falhou',
    openAnotherChatUnsupported: 'Atualize o Hermes Desktop para abrir outra conversa com o bot.',
    remoteConnectionsUnsupported: 'Atualizar o Hermes Desktop para conversar com bots em outras conexões.',
    chatEmpty: 'Diga alguma coisa para começar.',
    kickoff: 'Conte um pouco sobre você!'
  },
  avatar: {
    classicShapes: 'Formas clássicas',
    blobFromName: 'Cara de blob — tirada do nome do bot',
    unlockFollowsName: 'Desbloquear — o rosto segue o nome do bot novamente',
    randomize: 'Aleatório',
    tabBot: 'Bot',
    tabGenerate: 'Gerar',
    upload: 'Enviar',
    tabPet: 'Animais de estimação',
    removeImage: 'Remover a imagem — usar a forma',
    removeBackToShape: 'Remover — voltar a moldar avatar',
    describePlaceholder: 'Descreva o seu Avatar...',
    describeHint: 'Deixe em branco a geração automática do nome/título/descrição + lista de mensagens de agente.',
    matchTheName: 'Coincidir com o nome',
    pickPet: 'Escolha um animal de estimação como foto de perfil deste bot.',
    petLoadFailed: 'Não foi possível carregar aquele animal de estimação — tente outro.',
    imageTooLarge: 'Imagem muito grande (máx. 15MB).',
    generationFailed: 'A geração Avatar falhou',
    savedLocally: 'Falha ao salvar remotamente; a imagem foi salva apenas neste dispositivo.',
    savedLocallyDescriptionFailed: 'A imagem foi salva localmente, mas não foi possível atualizar a descrição.',
    generate: 'Gerar',
    generating: 'Gerando...'
  },
  group: {
    newTitle: 'Nova conversa de grupo',
    manageDesc: 'Um bot pode juntar várias conversas de grupo. Os membros sincronizam-se com todas as máquinas.',
    manageTitle: 'Gerenciar grupos',
    settingsTitle: 'Configuração do grupo',
    ...
    searchToAdd: 'Procurar bots a adicionar',
    searchToAddPlaceholder: 'Procurar bots para adicionar...',
    removeFromSelection: 'Remover da seleção',
    disbandTitle: 'Desmarcar conversa de grupo?',
    deleteTitle: 'Apagar a conversa em grupo?',
    deleteAction: 'Apagar',
    composerPlaceholder: 'Diga alguma coisa — todos os bots deste grupo acompanham a sala.',
    attachHint: 'Anexar arquivos — todos os bots que respondem os veem',
    ...
    collapseThread: 'Recolher o tópico',
    collapseThreadLabel: 'Recolher este tópico',
    activity: 'Atividade',
    noActivityYet: 'Ainda não há atividade neste turno.',
    showActivity: 'Mostrar atividade da sala',
    hideActivity: 'Ocultar atividade da sala',
    stop: 'Parar',
    stopHint: 'Pare esta execução — interrompe o membro em turno e detém o resto',
    allHeldStatus: count => `Tudo ${count} bots são pausados`,
    heldMembersStatus: members => `Pausa: ${members}`,
    holdReleaseHint: 'Mencione um bot pausado ou envie @all currículo para liberá-los.',
    needsYourInput: 'Um bot neste chat de grupo precisa da sua entrada',
    pictureGenerationFailed: 'A geração de imagens em grupo falhou',
    nameTaken: name => `Um grupo chamado “${name}” já existe.`,
    memberCount: count => `${count} bots`,
    settingsHint: group => `Configurações do grupo — renomear ${group} ou definir uma imagem da sala`,
    settingsLabel: group => `Configuração do grupo para ${group}`,
    disbandHint: group => `Dissolver o grupo ${group}`,
    disbandLabel: group => `Desmantelar ${group}`,
    disbandAction: 'Desmantelar',
    disbanding: 'A dissolver...',
    disbandDone: 'Desmantelado',
    disbanded: group => `Excluído “${group}”`,
    disbandDescPrefix: 'Isto remove o ',
    disbandDescSuffix: count =>
      ` grupo dos seus ${count} bots e limpa o histórico da sala compartilhada. Os bots e suas sessões individuais serão mantidos.`,
    stopped: group => `Parado ${group} — os turnos restantes são mantidos até ao seu reinício`,
    removeAttachment: 'Remover anexo',
    threadFallback: 'Tópico',
    replyCount: replies => `${replies} ${replies === 1 ? 'resposta' : 'respostas'}`,
    dropToThread: 'Soltar para anexar a esta resposta de tópico',
    dropToRoom: 'Soltar para anexar — todo bot que responde vê-lo',
    waitingForAnswer: 'Aguardando sua resposta...',
    memberThinking: name => `${name} está pensando...`,
    roomWorking: 'A sala está trabalhando...',
    messageRoom: group => `Mensagem ${group}`,
    newThreadPlaceholder: group => `Novo tópico ${group}... (@ nome para dirigir, @ everyone para todos)`,
    everyoneMeta: 'Todos os bots na sala',
    commandApproval: 'aprovação de comando',
    answerFailed: (handle, error) => `Não foi possível enviar a resposta para @${handle}: ${error}`,
    wantsToRunCommand: handle => `@${handle} deseja executar um comando:`,
    asks: handle => `@${handle} pergunta:`,
    answerTo: member => `Responder @${member}`
  },
  tools: {
    skillsHub: 'Centro de Habilidades Hermes',
    filterSkills: 'Filtrar habilidades...',
    searchHub: 'Pesquisar no hub (comunidade + fontes bem conhecidas)...',
    noMcpServers: 'Nenhum servidor MCP configurado ou no catálogo.'
  },
  cron: {
    filterHint:
    ...
    runHistoryOnly: 'Executar apenas o histórico',
    botChatTarget: bot => `${bot}bate-papo (bot responde)`,
    continuity: 'Continuidade: cada execução vê a saída da execução anterior (dedupe, continue onde parou)',
    onceIn: when => `Uma vez (${when})`,
    everyNDays: days => `Cada ${days} dias`,
    everyNHours: hours => `Cada ${hours}h`,
    everyNMinutes: minutes => `Cada ${minutes}m`,
    freqOnce: 'Uma vez, em...',
    freqHourly: 'A cada hora',
    freqDaily: 'Todos os dias',
    freqWeekdays: 'Semanais',
    freqWeekly: 'Todas as semanas',
    freqMonthly: 'Todos os meses',
    freqInterval: 'Intervalo',
    freqAdvanced: 'Avançado...',
    unitMinutes: 'minutos',
    unitHours: 'hora( s)',
    unitDays: 'dia(s)',
    runsOnce: (count, unit) => `Executa uma vez, daqui a ${count} ${unit}`,
    runsHourly: 'Executa no início de cada hora',
    runsDaily: time => `Executa todos os dias às ${time}`,
    runsWeekdays: time => `Executa de segunda a sexta às ${time}`,
    runsWeekly: (day, time) => `Funciona a cada ${day} em ${time}`,
    runsMonthly: (day, time) => `Funciona no dia ${day} de cada mês em ${time}`,
    runsInterval: (count, unit) => `Funciona a cada ${count} ${unit}`,
    runsRaw: 'Calendário em bruto — cada Nm/Nh/Nd ou cron de 5 campos',
    timesTotal: count => `, ${count} tempo(s) total(ais)`
  }
}
...
export const BOTS_LOCALES: PluginLocaleBundles = { en, ja, zh, 'zh-hant': zhHant, 'pt-BR': ptBR }
