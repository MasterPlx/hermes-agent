...
const ptBR: KanbanMessages = {
  ...
  countTip: (running, ready) => `Kanban — ${running} em execução, ${ready} prontas`,
  col: {
    triage: { label: 'Triagem', help: 'Ideias cruas — um especificador ajusta a especificação.' },
    todo: { label: 'A-fazer', help: 'Aguardando dependências, ou não atribuídas.' },
    scheduled: { label: 'Agendado', help: 'Aguardando uma hora marcada para chegar.' },
    ready: { label: 'Pronto', help: 'Dependências satisfeitas — atribua um perfil e o despachante execute-o.' },
    running: {
      label: 'Em execução',
      help: 'Alegado por um agente executor — um agente está nele. A postos pelo despachante.'
    },
    blocked: { label: 'Bloqueado', help: 'O agente executor pediu ajuda humana.' },
    review: { label: 'Revisão', help: 'Um agente de revisão está verificando o trabalho. A postos pelo despachante.' },
    done: { label: 'Concluído', help: 'Concluída; as tarefas dependentes ficam prontas.' },
    archived: { label: 'Arquivado', help: 'Escondido da vista padrão do quadro.' }
  },
  locked: {
    review: 'A revisão é introduzida pelo despachante quando um agente de revisão toma o cartão.',
    running: 'A execução é definida pelo despachante quando um agente executor reivindica o cartão.',
    scheduled:
      'O agendado precisa de um tempo de despertar — os agentes configuram-no; não pode ser arrastado para dentro.'
  },
  arcRunning: 'Um agente está trabalhando nisso agora.',
  arcStale:
    'Reivindicado, mas nenhum batimento cardíaco do agente executor por mais de 2 minutos — o despachante irá recuperá-lo.',
  title: 'Kanban',
  orchestrationSettings: 'Configuração da orquestração',
  newTask: 'Nova tarefa',
  filterCards: 'Filtrar as cartões...',
  noMatch: 'Nenhuma tarefa corresponde aos filtros',
  noTasks: 'Nenhuma tarefa neste quadro',
  open: 'Abrir',
  select: modifier => `Selecionar (${modifier}- Click)`,
  deselect: 'Desmarcar',
  moveTo: label => `Mover para ${label}`,
  delete: 'Apagar',
  reviewChecking: 'Um agente de revisão está verificando o trabalho concluído.',
  attachedTip: name => `${name} está anexado — o despachante entregará isso na próxima verificação (≤1 min).`,
  orchestratorTip: name => `${name} assumirá isso na próxima verificação e escreverá a especificação.`,
  autoAssignTip: name => `Atribui automaticamente a “${name}” (kanban.default assignee) no próximo envio.`,
  wontRun: 'não será executada',
  wontRunTip:
    'Tarefas prontas só são executadas quando têm um perfil atribuído. Abra o cartão e escolha um responsável ou configure um responsável padrão nas opções de orquestração.',
  noHeartbeat: 'sem batimento cardíaco',
  ...
  showArchived: 'Mostrar o arquivo',
  groupRunning: 'Grupo em execução pelo perfil',
  nSelected: n => `${n} selecionado`,
  moveToShort: 'Mover para',
  assign: 'Atribuir',
  unassignAction: 'Desatribuir',
  archive: 'Arquivo',
  clearSelection: 'Limpar a seleção (Esc)',
  refused: 'recusada',
  bulkFailed: (failed, total, err) =>
    `${failed} de ${total} falhou — ${err}. As cartões falhadas permanecem selecionadas.`,
  titlePlaceholderTriage: 'Idéia difícil — um especificador vai entendê-la',
  titlePlaceholder: 'Título',
  descPlaceholder: 'Descrição (opcional)',
  priority: 'Prioridade',
  workspace: 'Espaço de trabalho',
  boardDefaultSuffix: ' · predefinição do quadro',
  workspaceOverride: 'Localização do espaço de trabalho (sobreposição opcional)',
  model: 'Modelo',
  modelInherit: 'Perfil padrão',
  modelClear: 'Limpar a substituição do modelo',
  modelHint:
    'Execute esta tarefa em um modelo específico e profundidade de pensamento. O Unset use o próprio perfil atribuído.',
  workspaceInherit: 'Herda o pasta do projeto do quadro',
  workspaceInheritDir: dir => `Deixar vazio para herdar ${dir}`,
  workspaceInheritGeneric: 'Deixe em branco para herdar o pasta do projeto do quadro.',
  assignee: 'Destinatário',
  defaultOption: name => `${name} (padrão)`,
  parkedOption: 'não atribuído (estacionado — não funciona)',
  skills: 'Habilidades (separadas por vírgulas)',
  skillsPlaceholder: 'tradução, github',
  parent: 'Pai (bloqueia até que seja feito)',
  noParent: '— sem pais —',
  goalMode: 'Modo objetivo (loops do agente executor até que um juiz concorde que está feito)',
  creating: 'Criando...',
  createTask: 'Criar tarefa',
  cancel: 'Cancelar',
  save: 'Salvar',
  estimate: 'Estimativa',
  estimateEffort: 'Esforço estimado',
  estimating: 'Estimando...',
  reEstimate: 'Reestimar',
  makesModelCall: 'faz uma chamada de modelo',
  estimateTip: 'Token bruto + estimativa de complexidade do modelo auxiliar — faz uma chamada de modelo.',
  estimateTipLong:
    'Faz uma chamada rápida ao modelo auxiliar para estimar tokens e complexidade. É apenas uma estimativa, não uma medição exata.',
  roughEstimate: 'Estimativa aproximada',
  tokUnit: 'tok',
  couldNotEstimate: 'Não foi possível estimar',
  complexity: { S: 'Pequeno', M: 'Médio', L: 'Grande' },
  introBody:
    'Os agentes executam os cartões. Coloque um cartão em Pronto e atribua um perfil; um agente deverá assumi-lo em até um minuto. Sem responsável, ele não será executado. Na Triagem, um agente transforma a ideia em uma tarefa bem definida. A Fazer aguarda outras tarefas; Agendado aguarda o horário definido; Em execução e Revisão estão nas mãos dos agentes; Bloqueado aguarda você. Os resultados aparecem no cartão.',
  introGotIt: 'Entendido.',
  evtCreated: (where, assignee) =>
    `criado${where ? ` em ${where}` : ''}${assignee ? ` · atribuído a ${assignee}` : ''}`,
  evtMovedTo: col => `mudou para ${col}`,
  evtParentReopened: parent => `pai ${parent} reaberto`,
  evtAssignedTo: assignee => `atribuído a ${assignee}`,
  evtUnassigned: 'não atribuído',
  evtCommentBy: author => `comentário por ${author}`,
  evtClaimedReview: 'reivindicado por um agente de revisão',
  evtClaimedWorker: 'reclamado por um agente executor',
  evtWorkerStarted: 'início do agente executor',
  evtCompleted: 'completo',
  ...
  evtPromoted: 'dependências feitas — promovidas para Pronto',
  evtScheduled: 'programado para posterior',
  ...
  metaCreated: 'Criado',
  metaWorkerPid: 'Pid agente executor',
  readyUnassignedTitle: 'Pronto, mas não atribuído — este cartão nunca será executado.',
  readyUnassignedBody:
    'O despachante só reivindica cartões Prontos que tenham um atribuído. Escolha um perfil no campo Atribuído acima (ou defina um atribuído padrão nas configurações de orquestração) e ele será executado em um minuto.',
  diagnosticsN: n => `Diagnósticos · ${n}`,
  commandCopied: 'Comando copiado',
  description: 'Descrição',
  editDescription: 'Editar a descrição',
  ...
  blocks: 'Blocos',
  comments: n => `Observações · ${n}`,
  commentsHelpRunning:
    'Esta tarefa está em execução. Sua nota é dobrada no turno atual do agente executor em poucos segundos — sem dança de bloqueio/desbloqueado. “Require com nota” em vez disso, reinicia a tarefa do zero com sua nota em contexto.',
  commentsHelp:
    'Comentários são adicionados ao tópico tarefa. Quando um agente executor pega a tarefa, lê-los como parte de seu contexto.',
  send: 'Enviar',
  comment: 'Comentário',
  messageWorker: 'Mensagem para o agente executor em execução...',
  addComment: 'Adicionar um comentário...',
  deliveredLive: 'Entregue ao agente executor em questão de segundos.',
  requeueWithNote: 'Pedir com nota',
  notePosted: 'Nota publicada — agente executor',
  activity: n => `Atividade · ${n}`,
  runs: n => `Execute · ${n}`,
  workerLog: 'Registro do agente executor',
  workerLogTail: 'Diário do agente executor · cauda',
  attachments: n => `Anexos · ${n}`,
  noAttachments: 'Ainda não há anexos.',
  uploadAttachment: 'Enviar anexo',
  taskActions: 'Ações de tarefas',
  copyTaskId: 'Copiar o ID da tarefa',
  ...
  working: 'trabalhando',
  board: 'Quadro',
  newBoard: 'Nova quadro',
  newBoardDots: 'Novo quadro...',
  exportDots: 'Exportar...',
  importDots: 'Importar...',
  renameDots: 'Renomear...',
  settingsDots: 'Configurações...',
  exportBoardTitle: 'Quadro de exportação...',
  importBoardTitle: 'Importar quadro...',
  boardExported: path => `Quadro exportada para ${path}`,
  boardImported: name => `Importado ${name}`,
  boardImportedAs: slug => `Esta denominação foi tomada — importada como ${slug}`,
  renameBoardTitle: 'Mudar o nome do quadro',
  deleteBoardTitle: name => `Apagar "${name}"?`,
  deleteBoardConfirm:
    'O quadro é arquivado, não apagado — suas tarefas e anexos permanecem no disco e podem ser restaurados.',
  boardArchived: path => `Quadro arquivado para ${path}`,
  boardSettingsFor: name => `Configuração do quadro — ${name}`,
  name: 'Nome',
  boardNamePlaceholder: 'Nome da quadro',
  slug: slug => `Slug: ${slug}`,
  project: 'Projeto',
  noProject: 'Nenhum projeto (scratch sandboxes)',
  projectHintPre:
    'Novas tarefas são executadas no repositório do projeto (uma árvore de trabalho por tarefa); cada tarefa ainda pode substituir seu espaço de trabalho na criação. Gerenciar projetos com ',
  projectHintCmd: 'projeto hermes',
  createBoard: 'Criar quadro',
  orchestratorProfile: 'Perfil do orquestrador',
  defaultAssignee: 'Atribuído por padrão',
  defaultParen: '(padrão)',
  autoDecompose: 'Decompor automaticamente as tarefas de triagem',
  profileDescriptions: 'Descrições do perfil',
  profileDescriptionsHint:
    'Descrições guiam o roteamento do decompositor. Gerar automaticamente com o modelo auxiliar, ou escrever o seu próprio.',
  profileGoodAt: 'Em que é que este perfil é bom?',
  auto: 'Automático',
  notify: {
    completedTitle: 'Tarefa concluída',
    blockedTitle: 'Tarefa bloqueada — precisa de sua entrada',
    blockLoopTitle: 'Tarefa encaminhada para triagem — precisa de uma decisão',
    gaveUpTitle: 'Tarefa desistida',
    crashedTitle: 'O agente executor estoirou — irá tentar novamente',
    timedOutTitle: 'Tempo de trabalho esgotado — tentará novamente',
