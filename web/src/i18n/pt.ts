...
export const pt: Translations = {
  ...
  profiles: {
    ...
    confirmDeleteMessage:
      "Esta ação elimina permanentemente o perfil '{name}' — configuração, chaves, memórias, sessões, habilidades, tarefas cron. Não é possível anular.",
    created: "Criado",
    deleted: "Eliminado",
    renamed: "Renomeado",
  },
  ...
  pluginsPage: {
    ...
    rescanHint: "Re-analise depois de adicionar arquivos em disco para que a barra lateral detete novos manifestos.",
  ...
  config: {
    ...
    resetDefaults: "Repor preconfigurações",
    resetScopeTooltip: "Repor {scope} para preconfigurações",
    confirmResetScope: "Repor todas as configurações de {scope} para os valores padrão? Isto apenas atualiza o formulário — as alterações só são escritas em config.yaml quando clicar em Salvar.",
    resetScopeToast: "{scope} reposto para preconfigurações — reveja e Guarde para persistir",
  ...
  env: {
    changesNote: "As alterações são salvas em disco imediatamente. As sessões ativas detetam novas chaves automaticamente.",
    confirmClearMessage:
  ...
  oauth: {
    title: "Inícios de sessão de provedor (OAuth)",
    providerLogins: "Inícios de sessão de provedor (OAuth)",
    description:
    ...
    noProviders: "Não foi detectado nenhum provedores compatíveis com OAuth.",
    ...
    connectedClosing: "Conectado! A fechar…",
    ...
    enterCodePrompt: "Foi aberto um nova aba. Introduza este código se for solicitado:",
    pkceStep1: "Foi aberto um nova aba para claude.ai. Inicie sessão e clique em Authorize.",
    pkceStep2: "Copie o código de autorização mostrado após autorizar.",
    pkceStep3: "Cole-a abaixo e submeta.",
    flowLabels: {
      pkce: "Início de sessão pelo navegador (PKCE)",
  ...
  achievements: {
    ...
    share: {
      ...
      hint:
        "Compartilhar no X abre uma publicação já preenchida em uma nova aba. Clique primeiro em Copiar imagem se quiser anexar o distintivo de 1200×630 — o X permite colá-lo diretamente no editor da publicação. Baixar PNG salva o arquivo para uso em qualquer lugar.",
  ...
  kanban: {
    ...
    confirmArchiveMany:
      "Arquivar {n} tarefas? Elas desaparecerão da visualização padrão do quadro.",
    confirmBlockedMany:
    ...
    columnHelp: {
      triage: "Ideias bruta — um specifier vai detalhar a especificação",
